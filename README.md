# `libcxxwrap_julia_jll.jl` (v0.11.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/721448033e27b4e98264ec0100e5963837da742d/L/libcxxwrap_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/JuliaInterop/libcxxwrap-julia.git (revision: `c28f293b2bced9b0ccce38eede7b3b58f6b4c099`)
