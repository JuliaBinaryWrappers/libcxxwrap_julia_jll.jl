# `libcxxwrap_julia_jll.jl` (v0.9.7+3)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/5e9a890afa0fca2cbead7621c681255a73a2e94f/L/libcxxwrap_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/JuliaInterop/libcxxwrap-julia.git (revision: `f99cea3baf7e5fa0daefce93c5e55106fb81ae1a`)
