# `libcxxwrap_julia_jll.jl` (v0.10.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/11736aac26c40681380272151c146fedb88dedcb/L/libcxxwrap_julia/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/JuliaInterop/libcxxwrap-julia.git (revision: `847c000cfc04299574f429e2441622bca3a91826`)
